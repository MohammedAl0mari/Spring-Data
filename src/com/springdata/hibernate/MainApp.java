...
public class MainApp {
	...
	public static void main(String[] args) {
		SessionFactory factory = new Configuration()
				...
				.addAnnotatedClass(Person.class).addAnnotatedClass(Data.class)
				.addAnnotatedClass(Student.class).addAnnotatedClass(Info.class)
				.buildSessionFactory();
		...
		try {
			...
			session.close();
			for (Info inf : s1.getInfos()) {
				System.out.println(inf.getPhone());
				System.out.println(inf.getStudent().getName());
			}
